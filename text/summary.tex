...
\begin{minipage}[t]{\tablecolumnwidth}
      every \qty{60}{\second} (with $\ge10$~measurements during core phase)
\end{minipage} &
\begin{minipage}[t]{\tablecolumnwidth}
      every \qty{10}{\second} (with $\ge10$~measurements during core phase)
\end{minipage} &
\begin{minipage}[t]{\tablecolumnwidth}
      every \qty{1}{\second} (with $\ge10$~measurements during core phase)
\end{minipage}
\\
\hline
...
\textbf{1c: Measurement Type} &
\multicolumn{3}{p{3\tablecolumnwidth}|}{
      instantaneously sampled power consumption \textbf{or} continuously integrated energy counter
} \\
\hline
