\chapter{Step-by-Step to a Level 1 Submission Guide}
\label{sec:checklist}
...
% Level~2 allows to measure the power for a portion of the system and extrapolate a value for the entire system.
...
% Level~2 submissions include the average power of the core phase (see Section~\ref{sec:core_phase} for definition of core phase) and the average power of the full run sampled at least once per second.
% The submission should also include at least one idle power measurement.
