...
For Level 1, the power must be sampled at least once per second.
The submitted value should be the average of all power samples taken during the core phase of the run.
