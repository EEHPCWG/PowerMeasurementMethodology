...
Section~\numnameref{sec:AfPL}.  If you adjust for power loss, how you determined the power losses must be part of the submission.
...
Refer to Section~\numnameref{sec:A1GTRM} for more information about the
...
For some systems, it may be impossible not to include a power contribution from certain subsystems. 
...
Section~\numnameref{sec:A3SIiIP} for information about
...
Refer to Section~\numnameref{sec:PAaTEM} for the definition of a power-averaged
...
Measure the largest  of $ \frac{1}{8} $ of the compute-node subsystem, at least 10~kW of power, or 15 compute nodes.
