...
\noindent
Every workload has a core phase where it is maximally exercising the relevant component(s) of the system.
More power is often consumed in a workload's core phase than in its startup and shutdown phases.
The core phase typically coincides with maximum system power draw.
