...
\label{sec:EF}
\noindent
Reporting information about the cooling system temperature is required.  Reporting temperature allows for better
comparison of reported results, as there is a indirect correlation between temperature and power.
All Levels require both the in and the out temperature of the cooling system. For air-cooled systems, these are the in and out air temperatures. For liquid-cooled systems, these are the in and out temperatures of the liquid.
\wl
